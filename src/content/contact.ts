/** Copy transcribed from https://researchnxt.com/contact-us/ */
...
export const contactPage = {
  ...
  aside: {
    ...
    body: "Whether you are scoping a research programme, cleaning up a prospect database or planning an ABM campaign, tell us where you are and we will point you at the right starting place.",
  },
} as const;
