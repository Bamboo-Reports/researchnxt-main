...
export const manufacturingLeaders: Insight = {
  ...
  body: [
    ...
    { heading: "Efficiency before growth" },
    ...
    { heading: "Key insights from the report" },
    {
      list: [
        ...
        "Highest ROI seen in **predictive maintenance, IT and OT integration, and digital twins**",
      ],
    },
    ...
    { heading: "From automation to agentic AI" },
