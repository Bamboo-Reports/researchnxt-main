...
export const financeLeaders: Insight = {
  ...
  metaDescription:
    "The financial services edition of the Implementor's Guide to AI: 300+ survey responses and 6 expert interviews on why adoption is mainstream in banking, insurance and fintech while enterprise scale is not.",

  title:
    "Implementor's Guide to AI: Finance Leaders Transition from Caution to Customer-Centric Scale",
  published: "2025-12-01",
  excerpt:
    "The financial services edition: AI adoption is mainstream across banking, insurance and fintech, but compliance complexity and risk sensitivity keep it from reaching enterprise scale.",

  thumbnail:
    "/insights/implementors-guide-to-ai/finance-leaders-transition-from-caution-to-customer-centric-scale.png",
  thumbnailAlt: "Implementor's Guide to AI, the financial institutions edition",

  jotformId: "253343061174450",

  body: [
    "Research NXT, in partnership with Salesforce, has released the latest edition of the **Implementor's Guide to AI**, focused on **financial institutions**, including banking, insurance, and fintech enterprises. Drawing from **300+ survey responses and 6 expert interviews**, the report unveils how AI adoption has moved into the mainstream, yet enterprise-wide execution remains constrained by compliance complexity and risk sensitivity.",
