...
export const walterDeOude: ExpertInterview = {
  slug: "walter-de-oude",
  project: "south-east-asia-response-guide",
  perspective: "buyer",

  metaTitle: "Rise of Self-Service Platforms",
  metaDescription:
    "Walter de Oude, Founder of Singlife, on the insurtech opportunity, S$600 billion sitting idle in Singapore bank accounts, and why AI still needs quality advice behind it.",

  title: "Rise of Self-Service Platforms",
  person: {
    name: "Walter de Oude",
  ...
  thumbnail: "/experts/walter-de-oude.jpg",
  thumbnailAlt:
  ...
  highlights: [
    "How the need for a better kind of life insurance company that kept pace with the technological evolution gave rise to Singlife.",
    "Walter's observations on the state of the insurtech market in Asia.",
    "How artificial intelligence and machine learning should aid financial advisors to introduce quality advisory-based products and services.",
  ],

  pullQuote:
    "Business success is based on two things: good supportive shareholders and capital, and fantastic people that can get together around the aspirational goal or dream to deliver something truly spectacular.",

  exchanges: [
    {
      question:
        "I would like to start with your background and the journey in setting up Singlife and your aspirations with the business. Give us an overview of that.",
      answer: [
        "I am an actuary by profession, originally from South Africa. I moved to Asia in 2000, with most of my years since then being spent living in Singapore. I also spent a couple of years living in Japan, and about two and a half years in Mumbai, India, working for Swiss Re. Before Singlife, I was the chief executive of HSBC's insurance businesses in Singapore.",
        ...
        "We were also fortunate that many people believed in what we were trying to do. When others believe in your efforts, you can get great people to join your organisation, those who feel that they want to be part of that journey. You also get great investors who want to put capital behind what you are trying to achieve. Ultimately, the business's success is based on those two things: good supportive shareholders and capital, and fantastic people that can get together around that aspirational goal or dream, to collectively deliver something truly spectacular.",
        "It took us three years to go from the idea to securing our licence from the Monetary Authority of Singapore. In those three years, we had to raise capital and build the technical team, all before getting any revenue. However, once we launched in 2017, we grew astronomically, with this growth culminating in one of the biggest insurance deals in Southeast Asia: the acquisition of a 75% stake in Aviva Singapore and the merging of the similar capabilities of deep product knowledge, trusted advice, and one and a half million plus customers in the Aviva franchise. That has been our journey so far.",
      ],
    },
    {
      question:
        "You have launched Singlife Grow, positioned as an effortless digital investment-linked policy. What is the vision behind it, and what are the key problems you are attempting to solve with Singlife Grow?",
      answer: [
        "The original problem Singlife set out to tackle is that people needed digital access to life insurance. However, people do not wake up in the morning and decide that today is the day they buy a life insurance policy. So, we had to expand the problem statement as we grew, to incorporate a much bigger and more purposeful objective for us to pursue.",
        ...
        "In 2020, we introduced the Singlife Account, a mobile insurance savings product that gives users better returns in terms of crediting rates, but with 100% liquidity. Customers have the option of withdrawals using a Visa debit card and FAST transfers without the lock-ins that insurance savings plans typically require.",
        "This proved incredibly successful, and we were growing at an average of 400 to 500 new customers and assets under management between S$5m and S$6m a day. The Singlife Account is designed to put power back into individuals' hands and make their money work harder for them.",
    ...
    },
    {
      ...
      answer: [
        "The insurance industry shared a universal challenge in that wherever there was a need for face-to-face advice or interaction with customers, it had to take place with more difficulty. People were not willing to speak with too many others, and did not go out as much as they used to.",
        ...
        "Because of this, the Singlife Account's business model did incredibly well during the pandemic. We were not reliant on face-to-face interactions with customers, and people saw value in the products and services we were offering. When people see that a product is good, you do not have to do much marketing because its value speaks for itself. People then also advocate for it to others positively. That is when a business does fantastically well. We were a net recipient of business during the lockdowns and throughout this pandemic, but we see this behaviour and response continuing beyond this new normal as well.",
      ],
    },
    {
      question:
      ...
      answer: [
        "Technology changes all the time and trends can change in as brief a time as a quarter of a year. As a business, we need to be at the forefront of this change for our customers, identify what they need over time, and then bring a solution to the table.",
        ...
        "These trends will continue to evolve and expand. People will look for more ways to manage and grow their finances, whether that is through pure savings, short-term savings, or longer-term savings like Singlife Grow, or life insurance when you need to pass on your legacy to your family. That all becomes part of an ecosystem. The evolution happens when you bring all of these things together in the slickest, neatest, and most engaging experience for the customer. If you can do that, you will win.",
      ],
    },
    {
      question:
