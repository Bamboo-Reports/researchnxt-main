...
export const amiteshBaranwal: ExpertInterview = {
  slug: "amitesh-baranwal",
  ...
  metaDescription:
    "Amitesh Baranwal, Digital Marketing Manager at SK Finance, on integrating channels around one brand strategy, optimising in real time, and holding personalisation inside automation.",
  ...
  thumbnail: "/experts/amitesh-baranwal.png",
  thumbnailAlt: "Amitesh Baranwal, Digital Marketing Manager at SK Finance",
  ...
  exchanges: [
    {
      ...
      answer: [
        "I started my digital marketing career in 2018 as an intern, but later, in February 2019, I joined Money Mouth Marketing Inc. as a digital marketing executive, where I gained foundational experience in email marketing, social media management, SEO, and managing large-scale PPC campaigns. This role also helped me develop technical skills in WordPress, backlink management, and competitor analysis.",
        "Currently, I oversee all digital channels for SK Finance, SK Foundation, and GUL, managing a monthly PPC budget of over INR 500K. I focus on integrating content across platforms, optimising campaigns in real time using data-driven insights, and maintaining a cohesive brand presence. Throughout my career, I have faced challenges such as adapting to the rapidly changing digital landscape, which I have overcome through continuous learning and a commitment to innovation.",
      ],
    },
    {
      question:
    ...
    },
    {
      ...
      answer: [
        "Marketing automation has been a game-changer in my strategy, allowing me to scale efforts while maintaining precision and personalisation.",
    ...
    },
    {
      ...
      answer: [
        "One of the biggest challenges with automation is ensuring data integrity. Inaccurate or outdated data can lead to ineffective campaigns and a poor user experience. To address this, I have implemented regular data audits and cleansing routines. Another challenge is the complexity of integrating different tools within the marketing stack. For example, syncing data between a CRM and an automation platform can sometimes result in delays or discrepancies. To mitigate this, I work closely with IT teams to ensure proper API integration and data synchronisation.",
      ],
    },
    {
      question:
    ...
    },
    {
      ...
      answer: [
        "For the report, I would like to see a deep dive into the latest trends in digital marketing, particularly around AI and machine learning's role in automation and personalisation. Insights into case studies of successful campaign strategies, especially those that have effectively integrated emerging technologies, would be invaluable. Additionally, practical guidance on optimising digital marketing efforts in an increasingly fragmented media landscape would be beneficial. This includes strategies for balancing brand consistency with the need for platform-specific content and the evolving expectations of digital audiences.",
      ],
    },
  ],
};
