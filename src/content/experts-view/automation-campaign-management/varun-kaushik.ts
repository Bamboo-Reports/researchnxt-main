...
export const varunKaushik: ExpertInterview = {
  ...
  metaDescription:
    "Varun Kaushik, EVP and Head of Marketing at PolicyBoss, on three-step intent scoring, push and WhatsApp replacing email, a 72% Diwali renewal campaign, and one unified journey.",
  ...
  thumbnail: "/experts/varun-kaushik-policyboss.png",
  thumbnailAlt:
  ...
  highlights: [
    "PolicyBoss has undergone significant digital transformation, pivoting from a B2C to a B2B2C model with over 85% online business.",
    "AI-driven conversational bots and personalised features like live localisation and instant commission payments have boosted daily policy sales from 500 to over 1,500.",
  ...
  exchanges: [
    {
      question:
        "Please share a brief overview of your professional journey, which led you to your current position as the Executive Vice President and Head of Marketing at PolicyBoss. What are your primary responsibilities, and how have these responsibilities evolved since you joined the organisation?",
      answer: [
        "We have pivoted our entire business model at PolicyBoss, which was originally a brick-and-mortar insurance broker. Up until 2017-2018, our focus was primarily B2C. However, with the new POSP (Point of Sale Person) guidelines introduced by IRDAI, we saw an opportunity and shifted to a B2B2C model. Today, over 80-90% of our business is agent-driven, with more than 85% of that conducted online through our own digital platforms. This transformation has been underpinned by significant advancements in our back-end systems, including LMS, CRM, automation, and even robotic process automation for reporting and analytics.",
        ...
        "Our journey now continues with the integration of generative AI. We are currently building out an AI-powered, fully digital onboarding process that requires zero manual intervention. This is a complex project, involving three external partners and over 200 possible conversation flows. The 11-step onboarding journey aims to create a natural, human-like experience.",
        "On the automation front, we are implementing features to enhance both agent acquisition and productivity. For example, our industry-first Live Brokerage feature displays potential commission earnings in real time for agents, while our instant commission payment feature InstaPay eliminates the need for reconciliation completely and narrows down the typical 45-day wait, allowing agents to receive their commissions immediately after issuing a policy. These innovations have had a huge impact: since launching these features in June 2024, our daily online policy volume has grown from 500 to over 1,500.",
    ...
    },
    {
      ...
      answer: [
        ...
        "In terms of automation, once we have crafted the right messaging and tone, automation becomes the tool for execution. The foundational events in the insurance buying journey, search, quotation, decision-making, and payment, have not changed. However, the tone and clarity of our communication at each stage have evolved. Insurance marketing as a whole has become less cluttered, with a focus on simplifying information for consumers.",
        "A common barrier for consumers is the belief that insurance involves too much fine print. Surprisingly, this is often the same for other financial products like futures, options, or equities, which carry greater risk. Yet insurance uptake remains lower due to perceived complexity and unclear language. Addressing this, we are leveraging automation and adaptive, intelligent advisory tools to provide real-time tooltips, enhancing both agent and customer understanding.",
        "For example, car insurance add-ons have expanded in recent years. Without clear explanations, customers may drop off when encountering unfamiliar options. We are tackling this by embedding user-friendly guidance to make the process simpler and more intuitive. Automation orchestrates the communication flow, such as video journeys or successive reminders based on user actions or inactions, while these nuanced interventions build confidence and clarity in the process.",
        "All these improvements in experience are targeted at the POSP agents that partner with us, as they are the first point of contact for policyholders. Educating them, empowering them and building confidence within them has a trickle-down impact on end customers: the more in command these POSPs are, the more their end customers are bound to be sure and swift in their insurance-buying considerations and decision-making.",
    ...
    },
    {
      ...
      answer: [
        "Our approach to intent mapping is a three-step, interconnected process built into our homegrown system, which assigns a numerical intent score.",
        {
          ordered: true,
          list: [
    ...
    },
    {
      ...
      answer: [
        "On the retail side, customer preferences are increasingly leaning towards completing their transactions seamlessly on their mobile devices, without navigating through multiple screens. Convenience is now a critical factor across retail, not just in insurance. This shift is evident in the rise of quick-commerce platforms like Swiggy and Zepto, highlighting how mobile is no longer a secondary screen: it is the primary one.",
        ...
        "For promotional messages, WhatsApp has become our top-performing channel. Email and SMS, once key channels, are now primarily reserved for transactional notifications due to their high clutter. With inboxes overwhelmed by promotional emails from various brands, being a needle in a haystack does not serve our needs in a low-conversion category like insurance.",
        "Human behaviour supports this shift: while many tolerate hundreds of unread emails, an unchecked WhatsApp notification is much harder to ignore. Though more expensive than SMS, WhatsApp's higher engagement rate justifies its use. However, we selectively qualify users for WhatsApp to avoid spamming, ensuring our brand numbers are not marked as spam. This approach has yielded substantial results, especially in targeted campaigns.",
        "For example, we recently ran a WhatsApp renewal campaign for luxury car owners, personalised with their name, car model, insurance expiry date, and renewal options. Tied to the theme of a worry-free Diwali, we encouraged them to renew before the holiday. The campaign led to a 72% renewal rate among customers with policies expiring on Diwali, a result we had not seen in previous efforts.",
        "WhatsApp's effectiveness lies in its relevance and meaningful messaging. Messages must be action-oriented and specific. A successful WhatsApp campaign is not a mass broadcast: it is a direct, purposeful engagement. If a message is too preachy or generic, it is likely to get blocked. In this channel, relevance is paramount, and action-driven content is essential to maintain engagement.",
      ],
    },
    {
      question:
      ...
      answer: [
        "Having a clear retention strategy is essential, especially when planning around established benchmarks. A skilled marketer understands the key levers of conversion, and open-ended messaging will not cut it. The messaging must be highly relevant and concise.",
        "For instance, in hyper-local markets, using the appropriate local language is crucial. Sending a Hindi message to a region where it is not commonly spoken is ineffective. Similarly, using overly complex language or superlative terms just to sound impressive often backfires, leading to customer disengagement. Brands, particularly in the service industry, should adopt a tone of humility in their communications.",
        "Once the messaging is refined, it is important to anticipate potential points of failure and build a journey that accounts for these, with retargeting and re-engagement as integral parts of the overall strategy, not isolated components. A common mistake is creating separate journeys for marketing, retargeting, and re-engagement. In today's converged market, these need to be part of one cohesive, unified consumer journey with multiple stages.",
    ...
    },
    {
      ...
      answer: [
        "For us, ROI or ROAS is clearly measured by policy sales, including the number of policies sold and the premium value compared to targets. We also track renewal conversions and premium values, making it straightforward to quantify performance since it is all conversion-based.",
        "The challenge, however, lies in attributing the reasons for missed conversions. In India, there is still a cultural reluctance to openly share why a potential customer did not proceed with a purchase. Despite running surveys, response rates remain low, around 10%.",
    ...
    {
      question:
        "For the campaign management and automation report we are creating, what insights do you believe would add the most value for readers? Also, could you share some best practices from your own experience?",
      answer: [
        "I believe one of the most critical factors in marketing automation is knowing precisely what to automate and how to market it effectively. Success does not come simply from choosing a top-rated service provider; it requires clear objectives and a deep understanding of your own business needs. If you expect a service provider to handle both discovery and implementation without your clear guidance, that is a shallow approach.",
        "You need to make the necessary investments to be well-prepared, even if that means upskilling or bringing in expertise. Not everyone has in-depth knowledge of marketing automation's technical side, and there is no shame in that. With most providers now operating in a cloud-based environment, REST APIs and webhooks are standard for integrations, and many tools can handle revenue modelling directly within the system, eliminating the need for separate spreadsheets or accounting software. Another notable change is that today's integrations factor in a higher concentration of push calls from marketing automation systems, and more complex journeys see the deployment of PUSH as well as GET calls, especially in the case of two-way automated communications.",
        "Before you begin the automation journey, establish concrete, measurable objectives. It is essential to have tangible metrics, not just projections or hypotheses. Use either your own performance data or industry benchmarks as a baseline. Without these numerical milestones, marketing automation will likely fall short, and as a marketing leader, you will struggle to demonstrate its value.",
        "A second key consideration is maintaining flexibility and clarity in event definitions and consumer journey mapping. Many marketing automation conversations stall due to a lack of clarity in these areas. Be open to experimentation: even if you fail, the learning process is invaluable. In today's fast-paced world, it is sometimes necessary to test multiple strategies simultaneously across the same audience segment. Choose a service provider who understands your industry and business well; if both parties are learning through discovery, measuring impact becomes difficult, and results will likely feel suboptimal. A best practice I strongly recommend is building cohorts to simplify reading and acting upon sub-segmented behavioural trends. Another suggestion is to always take a funnel view for all campaigns, as for-information-only does not apply to today's marketing environments. Every marketing rupee spent needs to be attributed towards the desired impact and should have a number value, not a notional one.",
        "Finally, the tone of voice and metrics used in campaign management and automation should be tailored to each campaign and line of business. From my experience in both B2B and B2C, I have found that approaches like account-based marketing can be adapted for both. In B2B, ABM targets specific accounts with predefined values, activating an entire marketing engine around these key accounts. This principle can be applied to B2C as well, especially when targeting high-value transactions or luxury items. Flexibility in campaign design, tailored to the order value and customer profile, is crucial for success.",
        "Lastly, I strongly recommend that for any and every communication outreach that the brand makes, a control group should be created to exclude 2-5% of the audience and see the degree of variance in behavioural or action-oriented response between those who received the communication and those who did not.",
      ],
    },
  ],
};
