...
export const prasadPimple: ExpertInterview = {
  ...
  metaDescription:
    "Prasad Pimple, EVP and Head of Digital Business Unit at Kotak Life, on AI-driven automated bidding, chase journeys for drop-offs, WhatsApp bots, and blended attribution.",

  title: "Personalisation Beyond the Basics: How Kotak Life Engages Customers",
  person: {
    name: "Prasad Pimple",
  ...
  highlights: [
    ...
    "AI and machine learning are being leveraged for automated bidding in marketing campaigns, improving lead generation and reducing costs.",
  ...
  exchanges: [
    {
      ...
      answer: [
        ...
        "These verticals are supported by three enabling horizontals: e-sales (contact centre operations), e-ops (policy fulfilment), and digital technology (technical enablement for the digital business). My responsibility is to build and scale this digital business unit, positioning it as a primary channel for customer acquisition at Kotak Life.",
      ],
    },
    {
      question:
        "Given that the consumer insurance journey, from evaluation to purchase to onboarding, is now primarily digital, how has this digital transformation impacted Kotak Life's approach? Would you say the business is now almost entirely digital, or do offline components still play a significant role?",
      answer: [
        "The life insurance industry has seen significant digital transformation, with most processes now conducted digitally. At Kotak Life, customer interactions, be it onboarding or servicing, are largely digital. Through our digital ecosystem, we have established DIY customer journeys for D2C businesses, enabling customers or intermediaries to complete the entire process digitally. Even field sales operations have transitioned to digital, from explaining product propositions to payment collection, unless large payments require physical processing.",
    ...
    },
    {
      ...
      answer: [
        ...
        "AI and machine learning are increasingly integral to marketing, with most platforms now leveraging these technologies. For instance, in Google's ad bidding system, multiple optimisation methods are available, such as click optimisation, lead-focused bidding, and target CPA. Traditionally, a human would analyse campaign data periodically, gain insights, and adjust bidding strategies accordingly. However, this approach limits responsiveness due to the time needed for manual analysis and decision-making.",
    ...
    {
      question:
        "What are the major challenges you have encountered while implementing marketing automation?",
      answer: [
        "Starting an automation or machine learning project brings a high potential for challenges, as the process often requires significant time for the technology to learn and adjust before yielding optimal results. This initial phase demands patience, as machines need time to interpret data accurately and make informed decisions.",
        ...
        "There are three primary challenges in these projects:",
        {
          ...
          list: [
            ...
            "**Ensuring scalability:** Even if a project works well in its initial phase, scaling up can present its own challenges. We have observed that some solutions, while effective on a smaller scale, may not transition well to a broader application due to design limitations.",
          ],
        },
    ...
    },
    {
      ...
      answer: [
        "In marketing, personalisation and customisation are now essential to engaging customers effectively. Personalisation has advanced well beyond merely addressing a customer by name. Today, it is about understanding the customer's intent and crafting experiences that align with their unique journey and needs.",
        "For instance, if a customer begins the journey to purchase term insurance on our platform but drops off midway, we can identify their interest in this product. When they revisit our site, the landing page and banners can be tailored to guide them seamlessly back into the process, highlighting their selected product and offering support if needed.",
        "For those who do not return, we have established a personalised chase marketing strategy. Initially, a message is sent offering assistance, allowing them to select a time for a follow-up. If there is no response, we send a second message outlining the benefits of the selected product and provide options for further inquiries via callback. This continues with reminders that emphasise the product's unique features, discounts, and ease of purchase. If the customer remains unresponsive, we shift focus, suggesting other solutions like insurance for child education, retirement, or other goals. This approach ensures that each customer receives a personalised experience, whether they purchase or explore alternative solutions.",
    ...
    {
      question:
        "With audience preferences varying not only by age or demographics but also by content type and format, how do you manage this in a multi-channel landscape? How do you approach audience segmentation, content selection, and ROI measurement across these evolving platforms?",
      answer: [
        "To navigate the complexities of multi-channel marketing, we segment our approach based on customer engagement stages and preferences. Platforms like Meta and Google are key to prospecting new customers, as many are actively searching for solutions there. The format is often experimental; however, video works well for building awareness, while static banners and emails drive consideration, clicks and intent.",
        "When engaging customers who have already shown interest, email remains effective due to its ability to provide comprehensive information non-intrusively. SMS has seen declining relevance, especially as it is now primarily used for transactional alerts like OTPs. WhatsApp, however, has gained prominence as both an interactive platform for queries and a robust channel for communication. Its versatility allows for multiple content formats, and though it is more costly than SMS, it provides a closer, more responsive customer interaction.",
    ...
    },
    {
      ...
      answer: [
        ...
        "However, we do not follow a rigid model for business attribution. Instead, we combine both first-touch and last-touch attribution, acknowledging both the platform where a customer first engages and where the final conversion occurs, ensuring a balanced view of the customer journey.",
      ],
    },
    {
      question:
      ...
      answer: [
        "My main expectations from this report are twofold. First, I am keen to understand the experiments and strategies currently used across different industries, especially those that have proven successful over time. Learning how different sectors, such as e-commerce or FMCG, approach customer engagement for varying goals, whether building brand awareness or driving action, would provide valuable insights into what works and what does not for each marketing objective.",
        "Second, insights on customer behaviour changes, particularly those observed by other industries, would be highly beneficial. For instance, in digital marketing, there is often a crossover between online and offline influence. Understanding how other businesses perceive and measure the impact of digital marketing on both channels, and whether they view it through an omnichannel lens, would be invaluable for enhancing our own approach.",
      ],
    },
  ],
};
