...
export const protickBasu: ExpertInterview = {
  slug: "protick-basu",
  project: "navigating-corporate-commute-for-gccs-in-india",
  perspective: "buyer",

  metaTitle:
    "From Tactical Support to Strategic Enabler: How Employee Transport Shapes GCC Scale, Trust, and Performance",
  metaDescription:
    "Protick Basu, VP of Workspace at ANSR, on transport readiness as a proxy for operational maturity, commute predictability, and the risks of treating it as tactical.",
  ...
  thumbnail: "/experts/protick-basu.jpg",
  thumbnailAlt: "Protick Basu, Vice President of Workspace at ANSR",

  intro: [
    "In this conversation with Research NXT, Protick Basu, Vice President, Workspace at ANSR, shares why employee transport has evolved from a support function into a strategic determinant of Global Capability Centre performance in India. Drawing on his early career in hospitality and his current role overseeing pan-India workspace operations, Protick explains how predictability, safety, governance, and experience-led design in commute programmes directly influence productivity, talent outcomes, and leadership confidence at global headquarters. As GCCs grow from small setups to multi-site, multi-shift operations, he highlights how transport readiness increasingly reflects the maturity, resilience, and credibility of India's operations.",
  ],
  ...
  pullQuote:
    "In many ways, transport readiness becomes a proxy for how well India's operations are managed overall.",
  ...
  exchanges: [
    {
      ...
      answer: [
        "I began my career in hospitality with the Taj Group, and that environment shapes how I still think about operations today. In hotels, service excellence, discipline, and customer centricity are not optional. One of the biggest learnings from hospitality is consistency. You cannot afford peaks and troughs. Guests expect the same experience every day, every hour.",
    ...
    {
      question:
        "How does commute predictability translate into measurable productivity outcomes for time-sensitive and shift-based GCC teams?",
      answer: [
        "Predictability removes one of the biggest variables in daily operations. When employees arrive on time and without stress, productivity starts earlier. Teams are ready to work from the moment the shift begins.",
    ...
    },
    {
      ...
      answer: [
        "It is extremely significant. Most GCCs operate in large metros where commutes are long and unpredictable. The majority of the workforce is young, mobile, and tech-aware. Many employees have moved cities for these roles and live far from office locations.",
    ...
    },
    {
      ...
      answer: [
        "Risk governance is the most critical aspect; a single incident can impact the employer brand, especially for women's safety. Safety lapses expose organisations to legal liability and disrupt business continuity. Data security is another major concern, especially given GCCs' sensitivity to information risk. Lack of visibility into employee movement or vendor data handling creates vulnerabilities.",
    ...
    },
    {
      ...
      answer: [
        "Expectations shift from basic service availability to enterprise-grade predictability. GCCs typically start small and then grow steadily. In the early stages, leadership seeks basic yet competent transport services. Consistency and reliability are the primary expectations.",
