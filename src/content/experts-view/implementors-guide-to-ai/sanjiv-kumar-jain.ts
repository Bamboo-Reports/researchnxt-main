...
export const sanjivKumarJain: ExpertInterview = {
  slug: "sanjiv-kumar-jain",
  project: "implementors-guide-to-ai",
  perspective: "buyer",

  metaTitle: "AI-Led Transformation in Automotive Manufacturing",
  metaDescription:
    "Sanjiv Kumar Jain, Group CIO at Krishna Maruti Group, on machine vision, predictive maintenance, digital twins and the data governance behind AI in automotive manufacturing.",
  ...
  thumbnail: "/experts/sanjiv-kumar-jain.png",
  thumbnailAlt: "Sanjiv Kumar Jain, Group CIO at Krishna Maruti Group",
  ...
  highlights: [
    {
      title: "AI-Driven Manufacturing Innovations",
      description:
        "Adoption of machine vision for quality control, predictive maintenance using IoT, and AI-powered workforce training with AR/VR.",
    },
    {
      title: "Data Governance & Security",
      description:
        "Implementation of zero trust security models, multi-factor authentication, and robust data governance frameworks to protect AI-driven insights.",
    },
    {
      title: "Challenges in AI Adoption",
      description:
        "Overcoming legacy system constraints, high initial investments, and workforce skill gaps to drive digital transformation.",
    },
    {
      title: "Emerging AI Trends",
      description:
        "AI-powered supply chain automation, digital twins for process optimisation, and generative design for product innovation in automotive manufacturing.",
    },
    {
      title: "Measuring AI Impact",
      description:
        "Monitoring machine utilisation rates, defect reduction, cost savings, and predictive analytics to assess AI's effectiveness.",
    },
    {
      title: "Responsible AI Practices",
      description:
        "Ensuring explainable AI, unbiased decision-making, and sustainability-focused AI adoption in manufacturing operations.",
    },
    {
      title: "AI Implementation Strategy",
      description:
        "Start with the problem, not the technology: run proof of concepts, scale gradually, and optimise AI models for long-term success.",
    },
  ],
