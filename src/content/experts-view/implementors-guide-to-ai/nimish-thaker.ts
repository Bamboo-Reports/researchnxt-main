...
export const nimishThaker: ExpertInterview = {
  slug: "nimish-thaker",
  ...
  metaDescription:
    "Nimish Thaker, Head of Marketing at Spacewood, on AR visualisation, cutting 3D renders from two days to two minutes, and what a 90% unorganised industry needs from AI.",
  ...
  thumbnail: "/experts/nimish-thaker.png",
  thumbnailAlt: "Nimish Thaker, Head of Marketing at Spacewood",
  ...
  highlights: [
    {
      title: "AI and AR Integration",
      description:
        "Spacewood is exploring AI and AR tools to offer personalised furniture solutions and enable customers to visualise products in their homes.",
    },
    {
      title: "Operational Efficiency",
      description:
        "AI-powered tools, such as those for 3D image rendering, are expected to significantly improve efficiency by reducing production timelines and enhancing product presentation.",
    },
    {
      title: "Challenges and Expectations",
      description:
        "With 90% of the furniture industry unorganised, there is a pressing need for tools and solutions tailored specifically for this sector to bring structure and inclusivity to smaller players.",
    },
    {
      title: "Future Trends",
      description:
        "AR, AI-driven personalisation, and tech adoption among manufacturers are expected to reshape the furniture industry in the next 3-5 years, providing opportunities for innovation and customer-centric growth.",
    },
    {
      title: "Aggregator-Manufacturer Collaboration",
      description:
        "Aggregators rely on manufacturers for quality products, but manufacturers are poised to lead the industry transformation as they embrace tech-enabled solutions.",
    },
  ],
  ...
  exchanges: [
    {
      ...
      answer: [
        "My career journey began in Pune. After completing my MBA, I joined Volkswagen as a management trainee, handling brand, corporate and promotional events. This role was a blend of sales and marketing, which gave me early exposure to both domains. I worked there for about 8-9 months.",
        ...
        "In December 2012, I joined Spacewood, where I have spent the past 12 years shaping my marketing career. Initially, my role revolved around ATL (above the line) activities, including print media and radio. Over time, I transitioned into digital marketing and took on additional responsibilities like CRM.",
    ...
    },
    {
      ...
      answer: [
        ...
        "AI offers a solution to one of our biggest challenges: creating high-quality product images. Currently, producing a 3D-rendered image is time-intensive, often taking up to two days. However, we are in discussions with a Bangalore-based company that provides an AI tool capable of generating professional-quality images in under two minutes. This tool allows us to capture a product photo using a smartphone, change its background, and enhance its appearance instantly, simplifying what was previously a labour-intensive process.",
    ...
    },
    {
      ...
      answer: [
        "We do not face significant concerns regarding data regulations or privacy at the moment. The nature of our product, a need-based item like furniture, does not generate a high volume of data inflow. People typically inquire about our products when they are buying a new home or renovating, which are specific, planned events.",
    ...
    {
      question:
        "Your current AI-driven approach appears to focus on enhancing personalisation and customer experience through your SKUs. Could you elaborate on what specific outcomes you aim to achieve with this strategy? Are there any measurable improvements you expect to see as a result?",
      answer: [
        "Our primary aspiration is to leverage AI to enhance the personalised furniture customisation process. For example, using AI, we aim to analyse a customer's layout and provide tailored design suggestions and product inputs.",
        "Incorporating technologies like AR and VR, similar to the place it feature on platforms like Amazon, will allow customers to visualise furniture in their homes before purchasing. While we have started implementing this manually in select stores, we plan to scale it universally across all platforms. Currently, this process is manual, requiring store personnel to visit the customer's home, a time-consuming approach. AI will help streamline this by reducing reliance on manual efforts.",
    ...
    },
    {
      ...
      answer: [
        "In the furniture industry, there are two primary categories that brands typically operate in: customised furniture and ready-made furniture.",
    ...
    },
    {
      ...
      answer: [
        "The furniture industry often finds itself overlooked, as it does not neatly fall into categories like FMCG or white goods. It is a distinct industry with its own unique needs and challenges. Having tailored solutions or tools specifically designed for the furniture industry would be incredibly valuable.",
