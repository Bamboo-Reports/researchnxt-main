...
export const meeraIyer: ExpertInterview = {
  slug: "meera-iyer",
  ...
  metaDescription:
    "Meera Iyer, Co-founder and CEO of SkinQ, on the AI Mirror trained on Indian faces, why AI cannot yet replace a dermatologist consultation, and how to evaluate an AI purchase.",
  ...
  thumbnail: "/experts/meera-iyer.png",
  thumbnailAlt: "Meera Iyer, Co-founder and CEO of SkinQ",
  ...
  highlights: [
    {
      title: "SkinQ's Mission and Innovation",
      description:
        "SkinQ addresses unique skin challenges for brown and darker skin tones, offering clinically proven, dermatologist-formulated solutions that simplify skincare. The AI Mirror tool enhances customer engagement by providing tailored product recommendations based on accurate skin analysis.",
    },
    {
      title: "Marketing in a Saturated Market",
      description:
        "SkinQ faces the challenge of competing with over 1 lakh beauty brands in India. Strategies include leveraging prescriptions from dermatologists, promoting clinical efficacy through Meta and Google, and encouraging referrals.",
    },
    {
      title: "AI's Role in Skincare",
      description:
        "While AI tools like the AI Mirror help identify skin concerns, SkinQ relies on human expertise for personalised recommendations, especially for complex skin issues. The brand recognises the evolving potential of AI in automating tasks and enhancing customer experience but acknowledges its current limitations.",
    },
    {
      title: "Evolution of Marketing Technology",
      description:
        "Marketing has transformed significantly over the past decade, with platforms like Google and Meta becoming more AI-driven. Advanced analytics tools now provide seamless insights, enabling marketers to focus on strategic decision-making rather than manual data collation.",
    },
    {
      title: "Recommendations for AI Adoption",
      description:
        "Businesses should critically evaluate AI's relevance to their operations, the quality of data powering AI solutions, and their alignment with specific use cases. Clean data, contextual relevance, and clear objectives are key to unlocking AI's full potential.",
    },
  ],
  ...
  exchanges: [
    {
      ...
      answer: [
        "SkinQ is a derma-cosmetic brand founded by Dr Chytra Anand, a renowned dermatologist who has made significant contributions to the global dermatology community. Dr Anand represents India at the World Anti-Aging Congress and serves on the technical committee of the Skin of Color Society, an international organisation dedicated to understanding and treating skin issues specific to brown and darker skin tones.",
    ...
    {
      question:
        "You are targeting a significant portion of the global population, many of whom may search for products like fairness creams that do not align directly with SkinQ's offerings. How do you approach targeting across multiple channels in this context? How is your marketing funnel designed, and what role does technology play in enabling personalisation for the specific segment you are focusing on?",
      answer: [
        "The challenges we are tackling at SkinQ are not niche: problems like pigmentation and acne are widespread. However, the real challenge lies in standing out in a saturated market with over a lakh beauty and personal care brands on platforms like Nykaa and Amazon. Cutting through this clutter and effectively communicating SkinQ's unique differentiation and clinical superiority is critical, especially given our position as a premium brand.",
    ...
    },
    {
      ...
      answer: [
        "Honestly, it is challenging, and I am still figuring it out: it is very much a hit-and-miss process. The reality is, only a small fraction of people will give you the time to explain your product's value, and even fewer will take the leap to invest in a brand that costs twice as much as others making similar claims. This is why referrals are a key area I am focusing on. When someone trusted shares their experience, it creates a level of credibility that is hard to replicate through ads or influencers.",
        "For instance, when I speak to someone personally about SkinQ, they are often intrigued enough to consider trying it. Scaling that same level of trust across entertainment-driven platforms is much harder and remains a work in progress. We have seen that using doctors as brand advocates adds credibility, but even here, many brands pay doctors to promote their products, which makes differentiation harder despite our unique positioning as a dermatologist-founded and formulated brand.",
        "One strategy we are exploring is consistently targeting a specific group and maintaining communication over time. Sometimes, persistence alone drives curiosity and brings people to our site. However, there is still no magic formula, and I am open to new ideas on how to effectively scale awareness and trust in SkinQ.",
        ...
        "Personally, I have dealt with vitiligo for over 15 years, so I understand how skin issues can affect one's quality of life. That is why SkinQ's mission resonates so strongly with me. Our goal is to positively impact the lives of at least 10 million people by providing solutions that not only treat their issues but strengthen and protect their skin over the long term.",
        "These problems, acne, pigmentation and sensitivity, are incredibly common in people with our brown, melanin rich skin. Reaching more individuals, helping them try SkinQ, and seeing real results would truly be a monumental achievement for us.",
      ],
    },
    {
      question:
      ...
      answer: [
        ...
        "Moreover, skin treatment does not work in isolation. It is a holistic approach that considers other products the customer is using, their age, medical history, and any known sensitivities. For instance, some people cannot tolerate vitamin C, so we need to avoid recommending products containing it. Personalised consultation is crucial to ensure customers receive appropriate advice and avoid complications.",
        "While AI is evolving, it has not yet reached the level where it can effectively replace the personalised consultations we provide, which are highly case-specific. In categories like apparel or general fashion, AI chatbots may suffice, but in specialised fields like skincare treatment, we must exercise caution in automated recommendations to ensure customers achieve the desired results without adverse effects.",
      ],
    },
    {
      question:
        "On the AI Mirror side, it seems you have already achieved a significant milestone by enabling face scanning and providing personalised recommendations. Could you elaborate on how it works?",
      answer: [
        "Our AI Mirror is hosted on a separate platform that Dr Chytra collaborated with, and we pay a small platform fee for its usage. Interestingly, while many people use the AI Mirror for skin analysis, we have noticed a trend where a significant number do it just for fun rather than with serious intent.",
    ...
    },
    {
      ...
      answer: [
        "Two major channels for digital marketers today, Google and Meta, have evolved significantly over the past decade. Back in 2015, platforms like AdWords and Business Manager lacked creative-driven logic and were heavily manual. Over the years, tagging quality and data accuracy have improved dramatically, thanks to the vast data these platforms have collected. For instance, Google's ability to identify user demographics or interests was once questionable, but today, their classifications have become much more precise.",
        "However, this evolution has not been without challenges. Privacy concerns and global regulations have led to the removal of several targeting groups on Meta and the phasing out of third-party cookies on Google, impacting the ability to track individual behaviour. These changes peaked during the pandemic when online activity surged but are now gradually diluting as privacy laws tighten.",
    ...
    },
    {
      ...
      answer: [
        ...
        "Looking ahead, it is clear that AI will continue to replace certain roles, especially at the junior level in areas like content creation, video production, and design. While current tools are not yet good enough to replace human creativity entirely, they are improving rapidly. In the next five years, it will be fascinating to see how AI transforms the workforce and how companies adapt to these changes.",
      ],
    },
    {
      question:
      ...
      answer: [
        "Here are three key considerations for businesses exploring AI implementation:",
        {
          ordered: true,
          list: [
            "**Understand the real value of AI:** Today, AI is often a buzzword thrown around loosely, attracting both interest and investment. However, not all AI solutions are genuinely leveraging the technology. It is crucial to evaluate if AI is truly being used in a meaningful way and whether it has relevant use cases for your business. Simply adopting AI for the sake of it, without understanding its applications, can lead to wasted resources.",
            "**Evaluate the data powering the AI:** The effectiveness of any AI system depends on the quality and legitimacy of the data it is trained on. AI can provide information but does not inherently assess the accuracy of that information. For example, if you search for the best form of vitamin C, you will find conflicting answers, some driven by marketing claims, others supported by scientific research. AI systems need to be built on clean, reliable, and contextually appropriate data. A case in point is the SkinQ AI Mirror, which is more accurate because it is trained on Indian faces rather than relying on foreign datasets. The foundation of the AI determines the reliability of its outputs.",
            "**Align AI to your specific use case:** AI solutions should be tailored to address your specific business needs. For instance, while an AI chatbot might work well for certain industries, it may fall short for more specialised use cases that require deeper contextual understanding, like recommending skin treatments based on age, current product usage, and skin history. Ensure the AI solution you choose is fit for purpose and does not require extensive post-deployment adjustments to align with your business requirements.",
          ],
        },
