...
export const karthikAnantharaman: ExpertInterview = {
  slug: "karthik-anantharaman",
  ...
  metaDescription:
    "Dr. Karthik Anantharaman, Vice President of International Sales & Marketing at Apollo Hospitals, on AI in cancer diagnostics, connected health, patient-reported outcomes and prognosis-led treatment funding.",

  title:
    "How Apollo Hospitals Leverages AI to Revolutionise Patient Care and International Outreach",
  person: {
    name: "Dr. Karthik Anantharaman",
    role: "Vice President, International Sales & Marketing",
    company: "Apollo Hospitals",
  },

  thumbnail: "/experts/karthik-anantharaman.png",
  thumbnailAlt:
    "Dr. Karthik Anantharaman, Vice President of International Sales & Marketing at Apollo Hospitals",
  ...
  highlights: [
    {
      title: "AI in Diagnostics and Chronic Disease Management",
      description:
        "AI-enabled tools in diagnostics, for lung and breast cancer and PET scans, enhance accuracy and treatment planning. In chronic disease management, AI-powered follow-up programmes ensure timely diagnostics and care, while tools like PROM integrate patient feedback into care plans for conditions like diabetes and hypertension.",
    },
    {
      title: "Real-Time Data Integration for Improved Care",
      description:
        "Connected health solutions use AI for real-time data aggregation and remote specialist reporting, enhancing care delivery, reducing hospital stays, and supporting population health management.",
    },
    {
      title: "AI-Driven Marketing and Accessibility Innovations",
      description:
        "AI supports international healthcare marketing by documenting clinical outcomes and offering customised funding solutions, such as deferred payment plans tailored to patient prognosis, making healthcare more accessible.",
    },
    {
      title: "Enhancing Human Expertise with AI",
      description:
        "AI should enhance human expertise rather than replace it, with a focus on collaboration, real-time solutions, and aligning AI adoption with clear organisational goals.",
    },
    {
      title: "Emerging AI Trends",
      description:
        "Promising areas for AI in healthcare include cardiology, stroke management, ophthalmology, oncology, immunology, and transplant medicine. AI-enabled biomarkers and predictive diagnostics are paving the way for personalised medicine and improved treatment outcomes.",
    },
    {
      title: "Purpose-Driven AI Adoption",
      description:
        "AI adoption should be guided by clearly defined objectives and a focus on delivering meaningful outcomes, rather than simply following trends or fulfilling checklists.",
    },
  ],

  pullQuote:
    "From a patient experience standpoint, we have implemented a system called PROM (Population Reported Outcome Management), which is designed to track and measure patient outcomes after they leave the healthcare facility.",
  ...
  exchanges: [
    {
      ...
      answer: [
        "Over the course of my career, my experiences have spanned across MedTech, Pharma, and now integrated healthcare services delivery at Apollo. While we initially started as a hospital and caregiver organisation, we have evolved into a fully integrated healthcare company. Today, we are not just a healthcare provider but also a technology enabler, offering a comprehensive tech stack that supports various aspects of healthcare.",
    ...
    },
    {
      ...
      answer: [
        "In my current role, I oversee several key functions aimed at expanding and enhancing our healthcare services globally:",
        {
          list: [
            ...
            "**International patient services and medical value travel:** Many countries face challenges in accessing high-quality, affordable healthcare, particularly for tertiary and quaternary care. We address these gaps by offering competitive secondary care and advanced tertiary care programmes. India has emerged as a global hub for medical value travel, and our institution is a significant contributor to this. Patients from emerging economies and developed nations, including the US, UK, Canada, and Singapore, choose us for our differentiated value proposition: competitive pricing, instant appointment scheduling, and clinical excellence. The expertise of our medical team, including many doctors trained abroad who have returned to India, strengthens our global reputation.",
    ...
    },
    {
      ...
      answer: [
        "In my current role, we leverage technology, particularly AI, to drive advancements in diagnosis, treatment, and patient management. Let me break this down into three core areas:",
        "**1. Advancing diagnostics with AI**",
        "We are running three key programmes aimed at improving diagnostic accuracy and efficiency:",
        {
          list: [
            "**Lung cancer diagnosis (LDCT programme):** Using high-resolution CT scans, AI compares patient images with a database of confirmed lung cancer cases. This enables highly accurate, data-backed diagnoses by differentiating lung cancer from other conditions like pneumonia or lung cysts.",
            "**Breast cancer detection:** Advanced AI algorithms help identify and distinguish breast cancer from non-cancerous conditions. This technology, deployed across Apollo Cancer Center networks, has significantly improved early detection and treatment planning for breast cancer.",
            "**Digital PET scan diagnostics:** PET scans, a critical tool in cancer diagnosis and treatment planning, are enhanced by AI to provide precise insights into cancer staging and treatment options. This ensures accurate diagnostic results, further aiding clinical decision-making.",
          ],
        },
        ...
        "Chronic conditions such as diabetes, hypertension, thyroid disorders, and cancer require lifelong management. To address this, we have developed AI-powered follow-up programmes:",
        {
          list: [
    ...
    },
    {
      ...
      answer: [
        "AI has been immensely helpful, and I do not see any reason to doubt its potential when positioned and utilised correctly. One of the most common misconceptions is viewing AI as a replacement for doctors or resources. We have never approached it that way. Instead, we see AI as an enabler, an assistant that facilitates more informed decision-making, not as a competitor or substitute.",
    ...
    },
    {
      ...
      answer: [
        "The most important aspect, in my view, is data privacy. Ensuring data privacy involves restricting access to patient data exclusively to the patient and safeguarding it against unauthorised access. At the hospital level, this means protecting the data of all patients within the EMR system and ensuring that confidentiality is strictly maintained.",
    ...
    },
    {
      ...
      answer: [
        "My expectation from the report would be to keep it as practical as possible. While raising awareness is important, the core goal should be to inspire organisations to think, 'If others are doing this successfully, why can't we?'",
        "The report should foster a sense of collaboration, encouraging organisations to seriously consider and implement real, ready-to-use, real-time AI solutions. However, it is crucial to emphasise that AI adoption should not be about ticking boxes or chasing trends. Instead, organisations should start by clearly defining a purpose and then focus on delivering meaningful outcomes by leveraging AI solutions.",
      ],
    },
  ],
};
