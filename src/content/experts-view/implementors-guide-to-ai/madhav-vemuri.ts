...
export const madhavVemuri: ExpertInterview = {
  slug: "madhav-vemuri",
  ...
  metaDescription:
    "Madhav Vemuri, industrial automation and digital transformation leader, on predictive maintenance, supply chain optimisation and the roadmap manufacturers need to scale AI.",

  title:
    "AI in Manufacturing: Driving Digital Transformation and Intelligent Operations",
  person: {
    name: "Madhav Vemuri",
    role: "Industrial automation and digital transformation leader",
    company: "formerly ABB",
  },
  thumbnail: "/experts/madhav-vemuri.png",
  thumbnailAlt:
    "Madhav Vemuri, industrial automation and digital transformation leader",
  ...
  highlights: [
    {
      title: "From Automation to AI",
      description:
        "Manufacturing has evolved from operator-centric operations to AI-powered intelligence, fundamentally altering how industries perform.",
    },
    {
      title: "AI's Impact on Predictive Maintenance",
      description:
        "AI enables real-time monitoring of production critical assets, predicting failures well before they occur and so optimising the Total Cost of Ownership through pragmatic maintenance strategies.",
    },
    {
      title: "Supply Chain Transformation",
      description:
        "AI is moving supply chain planning and management from reactive to data-driven models and simulation tools, improving efficiency, reducing waste, and enhancing just-in-time approaches.",
    },
    {
      title: "AI Adoption Barriers",
      description:
        "Legacy infrastructure, fragmented data systems, and workforce upskilling remain key challenges to scaling AI initiatives and the gains they bring.",
    },
    {
      title: "Ethical AI & Compliance",
      description:
        "AI adoption must be accompanied by responsible governance, unbiased models, and compliance with industry regulations.",
    },
    {
      title: "The Future of Manufacturing",
      description:
        "AI-powered digital twins, autonomous decision-making, and hyper-personalisation will define the next phase of industrial evolution.",
    },
  ],
  ...
  exchanges: [
    {
      question:
        "Could you start with a brief about yourself, your journey, what you worked on, and what you are currently working on so that anybody reading this would understand the context?",
      answer: [
        "I started my career as an instrumentation engineer in 1987 with Instrumentation Limited, a public sector unit in Rajasthan. That was my formative time when I gained knowledge of correct engineering practices and designing complex process applications.",
        "In 1993, I joined ABB to take up steel sector-specific solutions. My strength has always been across core process industries. I worked on a few mega projects like Rourkela and Bokaro steel plants, dealing with continuous casters and Steel Melting Shop (SMS) projects. This experience exposed me to holistic industrial offerings beyond instrumentation and automation, encompassing power systems, plant electrification, process optimisation, and integration with mechanical and process subsystems.",
        ...
        "After a 34 year corporate stint, I decided to leverage my experience in a different way, so I started my own venture and began coaching and transforming startups. My focus has been on helping startups that need a 360-degree perspective, pragmatic business planning, solution enrichment and positioning strategies. Now, I continue this work across various industries, including life sciences, ed-tech, healthcare, and retail, beyond the core process and discrete industry sectors.",
      ],
    },
    {
      question:
      ...
      answer: [
        "When I started my career in 1987, we had a drafting solution called the DP Drafting Package. AutoCAD and other modern design tools did not exist at that time. We had only one electronic typewriter in the department and a few computer systems used only for DCS programming.",
        "Fast forward to today, technological advancements are unbelievable. Digital tools have unlocked tremendous value, improving productivity and innovation. Sales processes, for example, have moved from reactive, inquiry-driven approaches to proactive customer engagement methods supported by CRM tools like Salesforce and Zoho. Today, businesses track entire customer journeys, convert early opportunities into leads, and create predictive models for engagement. New techniques like sentiment and pattern analysis open up totally new paradigms in unleashing the full potential.",
        "In manufacturing, the maintenance approach has been significantly transformed due to the infusion of advanced technologies and AI/ML techniques. Previously, maintenance was dominantly time based or reactive: equipment failures led to repairs. Now, AI-driven condition based maintenance, supported by early fault detection and leading indicators, ensures that failures are prevented, reducing unwanted downtime and improving overall operational availability, reliability, and efficiency. AI is helping immensely in optimising production operations, energy consumption, and raw material usage, making industrial processes more efficient and cost-effective.",
      ],
    },
    {
      question: "What are the key AI use cases impacting manufacturing today?",
      answer: [
        "AI is impacting every aspect of the value chain. In supply chain management, for example, AI is eliminating manual inefficiencies. Earlier, material sourcing was based on fear of availability or delayed deliveries, leading to excessive stockpiling. Now, AI-powered procurement analytics provide actionable insights on material availability and when and where to buy from, ensuring optimal costs, uninterrupted production, and reduced waste across the entire value chain.",
        "On the production front, AI helps to optimise the overall business outcomes through a meaningful integration of IT and OT systems, monitoring raw material quality, tracking machine conditions, and connecting the business systems to maximise the enterprise value and customer experience. Industries like food and beverage and automotive manufacturing have successfully leveraged AI to streamline logistics and optimise production scheduling.",
    ...
    },
    {
      ...
      answer: [
        "AI implementation must be approached strategically. Many industries struggle because they adopt AI in silos without assessing the sustainability of the impact, rather than integrating it into a comprehensive digital blueprint at the plant or enterprise level.",
    ...
    },
    {
      ...
      answer: [
        "AI will be a necessity, not an option. Businesses that fail to adopt AI will be left behind. Future trends include autonomous decision-making AI models, AI-IoT integration for real-time monitoring, and enhanced AI-driven supply chain resilience.",
