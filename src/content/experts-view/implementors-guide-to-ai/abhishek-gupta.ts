...
export const abhishekGupta: ExpertInterview = {
  slug: "abhishek-gupta",
  ...
  metaDescription:
    "Abhishek Gupta, CMO at Edelweiss Life Insurance, on AI behind a 99.23% claims settlement ratio, predicting customer and distributor attrition, and the three-year Dataverse project.",
  ...
  thumbnail: "/experts/abhishek-gupta.png",
  thumbnailAlt:
    "Abhishek Gupta, Chief Marketing Officer at Edelweiss Life Insurance",
  ...
  highlights: [
    {
      title: "AI-Driven Innovation in Insurance",
      description:
        "AI is transforming core functions such as fraud detection, claims processing, and customer retention. Predictive models help identify high-risk cases and customers likely to attrite, enabling timely interventions and improving persistency ratios.",
    },
    {
      title: "Hyper-Personalisation at Scale",
      description:
        "AI empowers the creation of tailored insurance products that cater to specific consumer needs, making personalisation achievable at scale, which was previously unattainable.",
    },
    {
      title: "Challenges in AI Implementation",
      description:
        "Overcoming scepticism, consolidating scattered data through projects like Dataverse, and ensuring timely action based on AI insights were key hurdles. A robust analytics committee ensures strategic prioritisation of AI use cases.",
    },
    {
      title: "Future of Insurance Marketing",
      description:
        "Emerging trends include hyper-personalisation, proactive distributor engagement, enhanced fraud prevention, and improved customer communication through AI-driven automation and real-time insights.",
    },
  ],
  ...
  exchanges: [
    {
      ...
      answer: [
        ...
        "While I do not manage the top line directly, as part of the leadership team I am actively involved in contributing to and supporting the overall commitments we have made as a business. This holistic approach defines my role within the organisation today.",
      ],
    },
    {
      question:
    ...
    },
    {
      ...
      answer: [
        "AI is often associated with consumer segmentation or marketing, but its applications go far beyond that. It plays a critical role in backend processes, which indirectly impact customer trust and business outcomes. Let me illustrate this with two use cases.",
        "**Enhancing claims settlement ratio.** One of the most important metrics for a life insurance company is the claims settlement ratio, which reflects the percentage of claims honoured. This number is vital because it showcases the trustworthiness of the insurer to prospective customers. Currently, our claim settlement ratio is at an impressive 99.23%, placing us among the top five in the industry.",
        ...
        "**Reducing customer attrition.** In life insurance, customers often commit to paying premiums for 10-12 years, with average ticket sizes exceeding ₹1 lakh. Customer retention is critical for both profitability and ensuring the customer benefits fully from their policy. However, some customers may attrite before completing their payment terms.",
    ...
    },
    {
      ...
      answer: [
        ...
        "Once a model is adopted, we commit to it for at least 1.5 to 2 years, allowing time for adjustments and improvements rather than abandoning it if initial results fall short of expectations. This approach ensures we refine models effectively and achieve the desired level of accuracy over time.",
      ],
    },
    {
      question:
        "With the evolving governance and improved data sharing in the insurance industry, you have highlighted the enhanced quality and accuracy of information. How do you see the industry leveraging this data for both business and marketing use cases?",
      answer: [
        "With the new Data Protection Act, we must be cautious about how we use data. While we are still evaluating the implications of the Act, it is undoubtedly a step in the right direction, giving privacy back to consumers. As an industry, we need to evolve and create the best use cases around these new regulations.",
        ...
        "For example, a 25-year-old customer might purchase a term plan with a sum assured of ₹1 crore, locking in a low rate. However, as their income and responsibilities grow over the years, that initial coverage may no longer be adequate. Often, customers do not revisit or upgrade their insurance, assuming the initial policy suffices. Through enriched data and advisor relationships, we aim to identify life-stage changes and offer upgraded or customised solutions to meet evolving needs.",
        "While personalisation capabilities have improved, they still rely heavily on accurate and current customer data. We are seeing gradual improvement in data availability and customer willingness to share, but there is a long way to go. Currently, there is still some guesswork involved in understanding a customer's life stage and offering suitable products. Sharpening this process through better data will be key to enhancing personalisation and customer engagement.",
      ],
    },
    {
      question:
      ...
      answer: [
        "Our industry has faced a negative perception from the very beginning. Even before fraudulent calls became common, insurance advisors often struggled to get calls answered, and being known as an insurance agent frequently led to avoidance. This perception, while unfortunate, is not entirely unfounded. Historically, the industry has faced issues with mis-selling.",
        "While most of the industry today operates with integrity, some cases of mis-selling persist: for example, offering savings products or term insurance to retired people, which may not be suitable. Term insurance, for instance, is primarily an income replacement product and is not relevant for those without an income.",
        "That said, the situation has significantly improved. Mis-selling has reduced, as evidenced by the claims settlement ratios. Most life insurance companies now have settlement ratios above 85%, with private players averaging 90% or more. This reflects the cleaner data and quality of cases being handled. Although there is still work to be done, I believe the industry is continuously improving.",
      ],
    },
    {
      question:
      ...
      answer: [
        "The biggest challenges we faced in developing and implementing AI models can be summarised as follows:",
        {
          list: [
    ...
    },
    {
      ...
      answer: [
        "Personalisation has evolved significantly, moving towards hyper-personalisation. Historically, the industry operated on a one-size-fits-all approach, with the same product available to all customers. Now, AI enables us to customise products based on individual consumer requirements at scale, something that would be impossible without it. Here are the key areas where AI is making a significant impact:",
        {
          list: [
    ...
    },
    {
      ...
      answer: [
        "To approach AI implementation effectively, it is essential to begin with the basics. Here are four key recommendations:",
        {
          list: [
            ...
            "**Be patient:** AI is a learning process, results will not be immediate. Expect to experiment, iterate, and refine over time. Models will improve and become sharper, but patience is crucial during the initial stages of implementation.",
