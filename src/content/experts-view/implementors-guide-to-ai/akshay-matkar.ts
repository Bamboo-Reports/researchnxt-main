...
export const akshayMatkar: ExpertInterview = {
  slug: "akshay-matkar",
  ...
  metaDescription:
    "Akshay Matkar, Chief Growth Officer at Pressto, on dynamic pricing, fixing data quality before modelling, and the retail AI trends worth betting on over the next three years.",
  ...
  thumbnail: "/experts/akshay-matkar.png",
  thumbnailAlt: "Akshay Matkar, Chief Growth Officer at Pressto",
  ...
  highlights: [
    {
      title: "AI-Driven Innovations at Pressto",
      description:
        "Pressto has implemented hyper-personalisation, marketing automation tools, chatbots, dynamic pricing, and an in-house analytics tool to enhance customer experience, operational efficiency, and strategic market expansion.",
    },
    {
      title: "Data Quality and Privacy as Foundations",
      description:
        "Ensuring data accuracy, consistency, and security through robust governance frameworks, encryption, and privacy measures has been critical to building trust and enabling effective AI-driven decision-making.",
    },
    {
      title: "AI in Customer Engagement and Retention",
      description:
        "AI-powered tools like predictive analytics, sentiment analysis, and chatbots have improved customer acquisition, engagement, and retention by offering personalised experiences and proactive service delivery.",
    },
    {
      title: "Strategic AI Adoption and Change Management",
      description:
        "Addressing challenges such as resistance to change, biases, and scalability issues requires transparency, incremental implementation, and alignment of AI solutions with business objectives to deliver measurable results.",
    },
    {
      title: "Emerging Trends Shaping Retail",
      description:
        "AI trends like hyper-personalisation, visual search, AR/VR, supply chain optimisation, and consumer behaviour analytics are transforming retail, offering opportunities to enhance customer experiences and operational outcomes.",
    },
  ],
  ...
  exchanges: [
    ...
    },
    {
      ...
      answer: [
        "Pressto is an international brand originally from Spain, operating independently in different regions. Pressto India was launched in 2008 in Mumbai and focuses on providing premium laundry services.",
        ...
        "Pressto India follows a distinct **cluster model**, offering personalised services through different types of stores:",
        {
          list: [
            ...
            "**Junior stores:** Handle cleaning tasks under supervision.",
    ...
    {
      question:
        "How has AI influenced growth strategies in Pressto or other organisations you have worked with? In what ways has AI been integrated into expansion and growth initiatives?",
      answer: [
        "From my experience, AI has had a significant impact on both customer acquisition and retention strategies. My primary exposure to AI has been through its applications in **personalisation, chatbots, predictive analytics, ad optimisation, and customer sentiment analysis**.",
        "**1. Personalisation.** AI has revolutionised personalisation, especially in marketing communications. Today, it is not just about addressing customers by name; true personalisation involves understanding customer intent and delivering tailored experiences. For instance:",
        {
          list: [
        ...
        "**2. Chatbots and virtual assistants.** On the customer acquisition side, chatbots and virtual assistants are instrumental in:",
        {
          list: [
        ...
        "**3. Predictive analytics.** Predictive analytics plays a pivotal role in both acquisition and retention:",
        {
          list: [
        ...
        "**4. Ad optimisation.** AI enhances ad performance by optimising targeting and maximising ROI. While managing ad bids is relatively straightforward, achieving precise targeting and performance scaling requires intelligent algorithms to ensure the right balance between cost and effectiveness.",
        "**5. Dynamic pricing.** At Pressto, we are working on implementing **dynamic pricing** to create a win-win for both customers and the brand:",
        {
          list: [
        ...
        "**6. Sentiment analysis.** Sentiment analysis through metrics like customer satisfaction score and Net Promoter Score is vital:",
        {
          list: [
      ...
      answer: [
        ...
        "Equally critical is the protection of customer data. As a brand, our customers are our most valuable asset, and safeguarding their information is a top priority. To address privacy concerns:",
        {
          list: [
            ...
            "**Encryption and role-based access:** We have started encrypting sensitive data and implementing role-based access controls to restrict unauthorised access.",
        ...
        {
          list: [
            "Regular audits for data usage and modelling processes, similar to the audits conducted in other areas of the business.",
    ...
    },
    {
      ...
      answer: [
        "Implementing AI solutions comes with its fair share of challenges, particularly when it comes to gaining internal acceptance and ensuring smooth integration. Here are some of the key challenges I have encountered, along with strategies to address them.",
        "**Data quality and availability.** One of the most fundamental challenges is ensuring that the data fed into AI models is accurate, complete, and consistent. Poor data quality often leads to subpar model performance and unreliable outputs. When I joined Pressto, we encountered issues like inconsistent and incomplete data, which required immediate attention.",
        ...
        "To mitigate these issues, transparency and education are crucial. Explaining how AI models work and validating their outputs against historical data can help build trust. Training programmes and stakeholder involvement throughout the implementation process are also essential to foster acceptance and understanding.",
        "**Scalability and integration.** While simple use cases for AI are often easier to implement and gain acceptance for, scaling to more complex applications presents significant challenges. Advanced use cases may require substantial computational resources, modular system architectures, and cloud infrastructure.",
        ...
        "**Change management.** Another major challenge is resistance to change within the organisation. This often stems from a lack of understanding of AI systems or disappointment when AI outcomes do not immediately meet expectations.",
        ...
        "**Ethical and legal compliance.** Fortunately, I have not encountered significant ethical or legal compliance challenges in AI implementation so far. However, this does not diminish the importance of proactively adhering to data privacy and security standards. At Pressto, we prioritise ethical data handling, even in the absence of strict enforcement of regulations like GDPR in India. Measures like encryption, role-based access controls, and robust privacy policies have been implemented to protect sensitive information.",
    ...
    },
    {
      ...
      answer: [
        "Emerging trends in AI are poised to transform the retail industry, and several areas stand out as particularly impactful:",
        {
          ordered: true,
          list: [
            ...
            "**Visual search:** While not directly related to my current domain, visual search was a critical use case during my time at Candere, where we managed a catalogue of over 10,000 products. Visual search technology simplifies the customer journey by allowing users to find exactly what they are looking for, making it invaluable for e-commerce platforms with extensive inventories.",
            ...
            "**Sentiment analysis:** Customer sentiment has become a vital factor for brands. Decisions are increasingly driven by customer reviews, making sentiment analysis essential for tracking metrics like customer acquisition cost, customer satisfaction, and Net Promoter Score. This helps brands adapt strategies based on real-time customer feedback.",
