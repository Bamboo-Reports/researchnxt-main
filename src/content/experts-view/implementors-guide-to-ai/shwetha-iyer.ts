...
export const shwethaIyer: ExpertInterview = {
  slug: "shwetha-iyer",
  ...
  metaDescription:
    "Shwetha Iyer, SVP and Head of Marketing at Kissht, on AI-driven segmentation, a 40% cut in CAC, retention from 64% to 87%, and marketing responsibly with sensitive financial data.",
  ...
  thumbnail: "/experts/shwetha-iyer.png",
  thumbnailAlt: "Shwetha Iyer, SVP and Head of Marketing at Kissht",
  ...
  highlights: [
    {
      title: "AI-Driven Personalisation and Segmentation",
      description:
        "Kissht leverages AI for hyper-targeted customer segmentation, predictive analytics, and personalised communication, significantly enhancing engagement and retention.",
    },
    {
      title: "Enhanced Operational Efficiency and Campaign Performance",
      description:
        "AI tools automate reporting, real-time data analysis, and campaign optimisation, reducing CAC by 40% and improving retention rates and website traffic.",
    },
    {
      title: "Ethical and Transparent Use of Data",
      description:
        "The company prioritises data privacy and compliance, collecting minimal personal information, obtaining explicit consent, and maintaining transparency to build customer trust.",
    },
    {
      title: "Embracing Emerging AI Trends",
      description:
        "Kissht is adapting to trends like vernacular content, voice-based marketing, and omnichannel strategies, while exploring integration into super apps to provide seamless customer experiences.",
    },
    {
      title: "Future-Ready AI Strategies",
      description:
        "The focus is on deeper personalisation, programmatic media buying, and efficient content creation and repurposing using AI, ensuring scalability and relevance in a competitive fintech market.",
    },
  ],
  ...
  exchanges: [
    {
      ...
      answer: [
        "I am a seasoned marketing leader with 21 years of experience and a strong background in growing brands across categories. An advertising professional turned marketer, I am well-versed in brand building, PR, digital marketing, market research, growth strategies and product management.",
    ...
    },
    {
      ...
      answer: [
        "In today's world, automation and AI are non-negotiable. Marketing has evolved from being a creative function to a fully scientific function. Marketers now have to be marketing technologists who balance the art and science of marketing to deliver measurable results.",
    ...
    },
    {
      ...
      answer: [
        "We use AI across activities like content creation, website management, SEO and customer retention.",
        {
          list: [
            "**AI-driven segmentation and personalisation:** By leveraging AI, we create hyper-targeted customer segments based on demographics, behaviours, preferences, and even predictive analytics. This allows us to design highly tailored, personalised campaigns that resonate with different customer groups.",
    ...
    {
      question:
        "Have specific AI-driven tools or platforms (recommendation engines, marketing automation, or chatbots) significantly impacted Kissht's marketing success?",
      answer: [
        "We use generative AI for content creation and creative ideation. We also use data modelling tools for our customer retention campaigns and measurement. AI helps us forecast customer behaviour, such as the likelihood of purchase, churn, or conversion. This helps us optimise our campaigns by targeting high-potential customers with tailored offers or messages.",
        "We also use generative AI tools to generate personalised content, such as blog posts, social media updates, and email copy. These tools help us produce large volumes of content quickly and at scale, saving time for marketers while maintaining a personalised tone.",
      ],
    },
    {
      question:
      ...
      answer: [
        "AI helps us find the right audience attributes and curate the right messaging for them at the right time. We pick our cohorts with precision, and we are able to offer them relevant products and hyper-personalised messaging. This builds trust and credibility.",
      ],
    },
    {
      question:
      ...
      answer: [
        "Our customer retention rates have gone up from 64% to 87% ever since we started the microsegmentation of cohorts to deliver personalised communication and customised offers. Our website traffic has also gone up by 19%.",
      ],
    },
    {
      question:
    ...
    },
    {
      ...
      answer: [
        "AI can give rise to omnichannel strategies where fintech brands will need to deliver consistent, seamless experiences across various platforms: mobile apps, social media, websites, and even physical touchpoints like ATMs or retail kiosks.",
