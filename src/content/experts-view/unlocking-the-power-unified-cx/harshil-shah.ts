...
export const harshilShah: ExpertInterview = {
  slug: "harshil-shah",
  ...
  metaDescription:
    "Harshil Shah, Assistant Manager of IT at LTC International Qatar, on e-receipts across 18 stores, one standard of service across three brands, and CX under privacy constraints.",
  ...
  exchanges: [
    {
      question:
        "Can you share your professional journey leading to your current role as Assistant Manager of IT at LTC International Qatar LLC?",
      answer: [
        "I joined LTC International Qatar in April 2015, right after completing my Bachelor of Engineering in computer science from Gujarat Technological University in August 2014. After my graduation, I was on a job hunt and received an offer from Qatar. I started as an IT assistant, where my responsibilities were managing hardware issues, handling EDP jobs, and working with GRN tasks, as we are in the retail industry. I worked in this role for about two to two and a half years.",
        "In 2017, I was promoted to application analyst, where I became solely responsible for managing our ERP system, Microsoft Dynamics NAV. My journey continued, and in 2022 I was promoted to application engineer. Last year, in 2024, I was further promoted to Assistant Business Application Manager, IT, where I continue to grow and contribute to the company.",
      ],
    },
    {
      question:
        "What are your core responsibilities in managing IT operations, and how do they support the company's customer experience goals?",
      answer: [
        "As the assistant manager, my core responsibilities involve a wide range of tasks that support the smooth operation of the company. From supervising IT infrastructure, EDP, purchase, inventory, GRN, and logistics in the absence of my head of department, to handling servers, ERP and managing IT projects, I am involved in multiple aspects of the business.",
    ...
    {
      question:
        "How do you define a unified customer experience within the retail industry, and why is it essential for brands like LTC International?",
      answer: [
        "A unified customer experience within the retail industry means delivering a consistent, seamless experience, whether it is in-store, online, or through any marketplace channels. This approach ensures that customers feel valued and have a smooth, personalised experience no matter how they interact with the brand.",
        "For our organisation, which operates multiple brands like Homes r Us, Daiso Japan, and Carter's, providing an integrated CX is essential. Even though each brand serves a different audience and offers distinct products, it is crucial that customers receive the same level of service, attention to detail, and ease of interaction across all brands.",
    ...
    },
    {
      ...
      answer: [
        ...
        "On the other hand, we have a CRM that collects and analyses customer data from all platforms. This allows us to understand customer preferences, personalise marketing efforts, and offer tailored experiences, all while keeping the overall brand message consistent across platforms.",
        "By providing these technological solutions, our IT team ensures that our customers always experience the same high-quality service every time they come to us.",
      ],
    },
    {
      question:
      ...
      answer: [
        "To streamline our customer experiences, we have adopted a range of advanced technologies. For POS, we use both FEC and NCR POS machines integrated with LS Retail as our end-to-end business solution. This setup allows us to efficiently handle sales, inventory management, and customer transactions.",
        "Additionally, our ERP, Microsoft Dynamics NAV, ensures smooth backend operations from inventory to financial management. We are also moving to Microsoft's cloud ERP, Dynamics 365, which will provide even greater flexibility and scalability.",
        "For marketing and customer engagement, we use XENO, which allows us to manage our campaigns across multiple platforms like Meta, YouTube, SMS, and email. We use local media channels, including radio and outdoor LED screens, where we promote our new collections and build brand awareness. We have also developed a mobile app for both Android and iOS, which enables customers to easily browse and shop from anywhere, improving accessibility and convenience.",
    ...
    {
      question:
        "What are some key challenges you have faced in maintaining a seamless CX across multiple retail locations? How have you addressed these challenges through IT solutions or process improvements?",
      answer: [
        "One of the key challenges we have faced in maintaining a seamless customer experience across multiple retail locations, particularly in the Middle East, is dealing with customer privacy concerns, especially when it comes to gathering personal details like names and mobile numbers. This has been particularly challenging when interacting with female customers, as many are hesitant or offended when asked for such information, and it is even harder to explain why we need it. To address this, we have adapted our approach to customer engagement. We understand that privacy is a sensitive issue, so we are careful to communicate that the information is only used for enhancing their shopping experience and not for unsolicited marketing. However, to avoid discomfort or resistance, we have focused on alternative ways to communicate our brand messages without directly collecting personal data from customers.",
        "We have turned to regional news channels, radio stations, and magazines for our brand communication. This allows us to reach a broader audience while respecting individual privacy preferences. By using these local media channels, we can promote our new collections, brand awareness, and special offers in a way that feels less intrusive and more aligned with cultural expectations. Through these strategies, we ensure that we maintain a positive customer experience while also respecting the values and preferences of our diverse customer base.",
      ],
    },
    {
      question:
    ...
    },
    {
      ...
      answer: [
        "We understand the potential of innovations like AI-powered customer insights, self-checkout systems, and smart stores. However, since we deal in value stores and furniture, adopting self-checkout for larger items is not feasible, as customers need to go to the cash counter for billing. Still, we are exploring the possibility of implementing self-checkout for smaller items to streamline the process and improve convenience for our customers.",
      ],
    },
    {
      question:
