...
export const asishChathanath: ExpertInterview = {
  slug: "asish-chathanath",
  project: "unlocking-the-power-unified-cx",
  perspective: "buyer",

  metaTitle:
    "Transforming Healthcare with Technology: Insights from Marble Medical Hospital's IT Manager",
  metaDescription:
    "Asish Chathanath, IT Manager at Marble Medical Hospital in Qatar, on centralising two branches, a call centre cut from eight agents to five, and AI pre-checking insurance claims.",
  ...
  thumbnail: "/experts/asish-chathanath.png",
  thumbnailAlt:
    "Asish Chathanath, IT Manager at Marble Medical Hospital in Qatar",
  ...
  highlights: [
    "Asish has over 15 years of IT experience across India and Qatar, transitioning from hospitality to healthcare.",
    "At Marble Medical, he has led major IT upgrades, including data centre modernisation, ERP enhancements, and call centre improvements.",
  ...
  exchanges: [
    {
      ...
      answer: [
        ...
        "Currently, I serve as IT Manager at Marble Medical Hospital in Qatar. Since joining in 2022, I have overseen the restructuring of the hospital's data centre, implementing VMware and Fortinet firewalls, and managing the ERP system developed by a UAE-based R&D team. I lead a team of two and support two operational outlets, with a third branch scheduled to open soon.",
        "This diverse journey has allowed me to grow through challenges, adapt to different industries, and develop a holistic perspective on IT management. I am committed to leveraging my experience to contribute effectively to the organisations I work with.",
      ],
    },
    {
      question:
      ...
      answer: [
        "Currently, in my role at the hospital, I report directly to the directors and chairman. This provides the advantage of direct communication for budget discussions and long-term IT planning.",
        ...
        "The ERP system, which was underutilised when I joined, has since been significantly expanded. Initially limited to billing, call centre, and basic EMR functions, we integrated laboratory modules, connected lab equipment, and developed a new operating room module tailored to our focus on plastic surgery. This module now links consumables with requisitions, streamlining workflows and enhancing operational efficiency.",
    ...
    {
      question:
        "From a patient experience perspective, how are you ensuring a unified and seamless experience across various interactions using technology? How do you monitor and maintain this consistency?",
      answer: [
        "Since joining, one of my primary observations was the gap in our call centre operations and customer relationship management. While my role is primarily IT-focused, I have actively engaged in enhancing our marketing and customer engagement processes.",
        "Previously, the clinic relied on traditional SMS for communication, which, as I observed, is no longer impactful. People tend to view SMS primarily for transactional purposes, like OTPs. To modernise our approach, we integrated WhatsApp Business for all our marketing and communication needs. This platform provides two-way communication, which is far more engaging and effective than SMS. However, full integration with our systems is still in progress, as we depend on our R&D team in Dubai to finalise the implementation, which we expect to go live within a month.",
        "On enhancements in customer engagement:",
        {
          ordered: true,
          list: [
            "**Centralising call centre operations:** We upgraded from a fragmented system to a centralised call centre using the 3CX platform. This allowed us to implement customised reports and dashboards that provide real-time insights into agent performance, call volume, abandoned calls, and active calls. While we lack a CRM system, we have developed interim solutions like manual reports and tools like Monday.com for performance tracking. This process has room for improvement, and I have proposed a CRM solution in our 2025 budget plan to address these inefficiencies.",
            ...
            "**Patient registration and feedback:** New patients fill out a tablet-based form, developed in-house, capturing essential data, including how they discovered our clinic. This information is processed manually into our ERP system and used for future marketing analytics. After consultations, patients are asked to complete a feedback form on a tablet. This process aligns with upcoming HSPA regulations in Qatar and helps us gather insights to improve clinic efficiency. The feedback system is built using Jotform and functions as an interim solution until we implement a full CRM.",
    ...
    },
    {
      ...
      answer: [
        "Certainly, in the Middle East, maintaining patient records for a minimum of five years is a mandatory standard, which underscores the importance of robust, technology-driven solutions. At Marble, we have found that integrating tools like WhatsApp Business and chatbots significantly simplifies and enhances the patient experience.",
        ...
        "Additionally, delivering lab results or updates via instant messaging platforms like WhatsApp makes the process more user-friendly. While email remains relevant, it is undeniable that most people prefer the immediacy and convenience of receiving updates directly on their smartphones. Having everything accessible with a single click or notification streamlines interactions and reduces the reliance on traditional methods.",
    ...
    },
    {
      ...
      answer: [
        "Currently, we have not integrated AI into our operations yet, but we are taking steps toward its implementation. One of our primary focus areas is addressing the challenges associated with insurance claim rejections. With eight insurance companies in Qatar, we have observed recurring issues such as missing details, incorrect dental codes, unclear X-ray images, and date mismatches. These errors result in claim rejections, which create an additional workload for our insurance coordinators.",
        "To tackle this, we are partnering with an AI-powered platform recently launched in Qatar. This platform leverages AI to pre-evaluate claim forms before submission to the insurance companies. The system analyses claims based on each insurer's unique policies, co-payment structures, and requirements. It identifies errors and provides feedback, enabling us to make corrections before submission. This proactive approach aims to reduce rejection rates and improve the efficiency of our claims process.",
    ...
    {
      question:
        "Are there any specific areas you would like us to cover in the report that would provide valuable insights for professionals like you in customer experience management?",
      answer: [
        "I am particularly interested in understanding how new technologies, especially AI, can transform marketing in the medical industry. While tools like CRM and BI are now standard, I would like to explore what innovative technologies or advancements AI can bring to marketing beyond these traditional approaches. For example, how can AI enhance customer relationships and engagement in ways that go beyond the current trends? This is an area I am keen to learn more about.",
      ],
    },
  ],
};
