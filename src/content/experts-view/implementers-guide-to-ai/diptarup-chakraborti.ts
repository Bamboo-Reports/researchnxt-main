...
export const diptarupChakraborti: ExpertInterview = {
  slug: "diptarup-chakraborti",
  ...
  metaDescription:
    "Diptarup Chakraborti, CMO at MoveInSync, on four eras of marketing technology, why most organisations sit at 4 out of 10 on AI adoption, and storytelling reclaiming centre stage.",
  ...
  thumbnail: "/experts/diptarup-chakraborti.png",
  thumbnailAlt: "Diptarup Chakraborti, Chief Marketing Officer at MoveInSync",
  ...
  highlights: [
    {
      title: "Evolution of Marketing and Technology Integration",
      description:
        "Marketing has evolved from a support function with minimal technology use to a growth driver powered by AI and digital tools, transforming how businesses engage with customers.",
    },
    {
      title: "Impact of AI on Marketing",
      description:
        "AI enables personalisation at scale, predictive analytics, and enhanced customer experience. It automates routine tasks, allowing marketers to focus on creative strategies and storytelling.",
    },
    {
      title: "Future of SaaS Marketing",
      description:
        "AI agents and concepts like results as a service are reshaping SaaS marketing, requiring marketers to shift from operational roles to storytelling and value articulation.",
    },
    {
      title: "Challenges in AI Adoption",
      description:
        "Organisations face barriers to AI adoption due to limited understanding, underutilisation of existing tools, and a reluctance to embrace AI's full potential.",
    },
    {
      title: "Responsible AI and Skill Evolution",
      description:
        "Responsible use of AI in marketing demands a balance between automation and creativity. The future will require marketers to develop skills in storytelling, customer empathy, and data interpretation.",
    },
  ],
  ...
  exchanges: [
    {
      question:
        "Over the past few years, you have worked with a variety of organisations, ranging from startups to larger companies. How have you observed the adoption of technology, particularly AI, evolve during this time? How has your journey as a marketer been influenced by these advancements?",
      answer: [
        "I began my journey in marketing with IBM, which at the time was the largest IT company in the world. Back then, marketing had minimal reliance on technology, unlike today, where nearly every function and tactic is deeply intertwined with technological advancements. When I started, even the concept of commercial use for the World Wide Web was in its infancy, emerging in the late 1990s and early 2000s. During this period, websites were not as integral to marketing strategies as they are now.",
    ...
    {
      question:
        "You have been involved in the B2B SaaS space in your recent ventures. What are your observations on B2B marketing trends, and how do you see AI shaping this landscape?",
      answer: [
        "SaaS has been around for nearly two decades. The concept of cloud computing gained traction in 2006, and by 2008, terms like SaaS, infrastructure as a service, and platform as a service were introduced. Today, we live in a world where everything as a service has become the norm. While SaaS itself is not new, the SaaSification of technology has led to a profound shift: the consumerisation of B2B marketing.",
    ...
    {
      question:
        "Having been in SaaS marketing for two decades, what changes have you observed in marketing, especially around AI?",
      answer: [
        "AI's influence on marketing has been profound and disruptive, evolving significantly over the past few years. It has moved from being a quiet, supportive tool to an all-encompassing force, fundamentally reshaping how we approach marketing functions.",
    ...
    },
    {
      ...
      answer: [
        "AI has brought significant advancements across various areas of marketing, driving better personalisation, customer experience, analytics, and predictive insights. Let me break it down with some use cases.",
        "**Personalisation at scale.** Previously, personalisation involved tailoring content for a handful of individuals based on known data points, like their location or preferences. For instance, if I know you are from Kerala and studied at a particular institute, I could write a personalised email incorporating these details. While feasible for a few people, it is impossible to scale this level of personalisation to thousands.",
        ...
        "**Enhanced customer experience.** AI also transforms customer journeys. For instance, when visiting a website, a user might not explicitly state what they are searching for. AI can analyse browsing behaviour in real time to predict their needs and dynamically present relevant content, making navigation intuitive and frictionless.",
        ...
        "**Predictive analytics and insights.** AI excels at analysing vast datasets to identify patterns and predict behaviours. In retail, it might determine that customers who buy shampoo often purchase shaving foam next. Based on this insight, stores can place these items together to trigger impulse purchases, boosting sales.",
        "In B2B marketing, intent analysis powered by AI allows businesses to identify potential customers actively seeking solutions they offer, even if the customer has not directly engaged with them. For instance, if someone is researching properties in Pune, AI can signal that interest, enabling targeted outreach with relevant offers.",
        "**Automation versus AI.** It is important to distinguish AI from automation. Automation performs repetitive tasks, like sorting mail into zones at a post office, without intelligence. AI, however, introduces intelligence to the process. In the same mail-sorting example, AI could analyse the volume of deliveries for each postman and dynamically allocate work based on capacity, optimising efficiency.",
        "**Positive impact at scale.** What sets AI apart is its ability to operate at scale. Whether it is tailoring communication for thousands of customers or analysing vast datasets for actionable insights, AI removes the limitations of human capacity, enabling marketing efforts that are both efficient and highly personalised.",
    ...
    },
    {
      ...
      answer: [
        "I believe the question of responsible AI use ties closely to the role of human creativity and ingenuity. Organisations should not settle for standard outputs but strive for originality and creativity, which are inherently human traits. AI, at least for now, cannot replicate the ability to think of entirely new ways to approach problems or innovate beyond its programmed parameters.",
    ...
    },
    {
      ...
      answer: [
        "I cannot comment on my current organisation, but reflecting on the companies I have worked with over the past five to seven years and others I have interacted with, both large and small, I would rate most organisations at about 4 on a scale of 10 in AI adoption, where 10 represents advanced and comprehensive use of AI.",
        ...
        "In essence, while there is a lot of buzz around AI, the depth and scale of its implementation remain limited. Most organisations I know, even internationally, have not moved beyond the early stages of AI utilisation.",
      ],
    },
    {
      question:
      ...
      answer: [
        "Understanding what AI can and cannot do is the key challenge holding back its widespread adoption. There is also a degree of fear and hesitation. Right now, AI is surrounded by hype, driven by major players like Google, Microsoft, Meta, and Amazon, who are pushing AI into the spotlight. For example, Microsoft recently stated that SaaS is dead and predicted that 98% of SaaS companies may shut down, an ironic statement from a company whose significant revenue comes from Azure cloud computing.",
        "This shift shows how these tech giants are repositioning AI, with initiatives like Microsoft's Copilot becoming a central revenue driver.",
        "The concept of results as a service, or outcomes as a service, powered by AI agents, will likely accelerate adoption. Today, most organisations claim to use AI because nearly every tool integrates some form of it, no matter how basic. For instance, a conversation recorded and transcribed by AI might technically qualify as AI adoption, but it is far from meaningful integration. This superficial use highlights a gap in understanding AI's true potential.",
        "Historically, any technology sees widespread adoption only when leaders in the field start actively promoting and pushing it. AI gained prominence largely because of generative AI advancements, which shifted the narrative. Tools like Siri and Alexa have been around for over a decade, but they were not marketed as AI: they were seen as niche applications. Now, AI is being positioned as transformative, much like how cloud computing and SaaS gained acceptance when major players began advocating for their benefits.",
    ...
    },
    {
      ...
      answer: [
        ...
        "Additionally, you should explore the evolving skill sets required for future marketers. Talents like storytelling, customer empathy, and the ability to interpret data creatively will become critical. It is important to outline what marketers will need to excel in this new AI-driven landscape.",
        "Another key point is the positive impact AI can have on marketing efficiency and productivity. This goes beyond just numbers and analytics. It is about enhancing the ability to deeply understand customers, predict their behaviour with precision, and weave those insights into compelling narratives. These elements should be central to the discussion, as they represent the transformative potential of AI in shaping the future of marketing.",
      ],
    },
  ],
};
