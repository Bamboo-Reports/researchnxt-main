...
export const prasadPimple: ExpertInterview = {
  slug: "prasad-pimple",
  ...
  metaDescription:
    "Prasad Pimple, EVP and Head of Digital Business Unit at Kotak Life, on CRM as the single source of truth, generative AI in the contact centre, and AI-driven medical underwriting.",

  title:
    "Insights on Data Unification, Customer Experience, and Ethical Innovation",
  person: {
    name: "Prasad Pimple",
    role: "Executive Vice President and Head of Digital Business Unit",
    company: "Kotak Life",
  },

  thumbnail: "/experts/prasad-pimple.png",
  thumbnailAlt:
    "Prasad Pimple, Executive Vice President and Head of Digital Business Unit at Kotak Life",

  intro: [
    "Step into the world of innovation and digital transformation with Prasad Pimple, Executive Vice President and Head of Digital Business Unit at Kotak Life, as he shares his visionary approach to leveraging AI and data unification. In this interview, Prasad reveals how AI-powered solutions, such as chatbots, real-time analytics, and generative AI in contact centres, are revolutionising customer acquisition, retention, and operational efficiency. He highlights the importance of ethical AI adoption, phased deployments, and setting achievable goals, while offering a forward-looking perspective on groundbreaking advancements in AI-driven medical underwriting and insurance practices.",
  ],

  highlights: [
    {
      title: "Data Unification and CRM as a Single Source of Truth",
      description:
        "By centralising customer data through a CRM system integrated with analytics tools, the organisation achieves a 360-degree view of customers. This enables seamless tracking, personalised communication, and improved decision-making across customer acquisition and retention campaigns.",
    },
    {
      title: "AI-Driven Campaign Optimisation and Engagement",
      description:
        "AI tools, such as Meta's Conversion API and Google Analytics, optimise campaigns by focusing on mid and bottom-funnel actions, resulting in precise targeting and improved conversion rates. Chatbots enhance customer interactions, assist in policy renewals, and deliver personalised updates, boosting satisfaction and loyalty.",
    },
    {
      title: "Contact Centre Transformation through Gen AI",
      description:
        "Gen AI solutions address variability in agent performance by providing consistent service, real-time feedback, and quality assurance. AI audits 100% of calls, offering actionable insights to agents and enabling real-time corrections for superior customer experience.",
    },
    {
      title: "Ethical AI Implementation and Data Transparency",
      description:
        "The organisation embeds ethical AI practices by ensuring transparency, obtaining informed customer consent, and adhering to regulatory standards. Processes like liveness checks and photo ID verification build trust and maintain data integrity.",
    },
    {
      title: "Future Trends in Insurance with AI",
      description:
        "AI is expected to revolutionise medical underwriting by replacing invasive physical tests with non-invasive, AI-driven assessments, simplifying the insurance process.",
    },
  ],
  ...
  exchanges: [
    {
      ...
      answer: [
        "From a data unification perspective, most of the industry is using multiple platforms rather than a single Customer Data Platform (CDP). While we do not rely on a standalone CDP, the CRM acts as the central hub for unifying customer data and driving actionable insights.",
        {
          ordered: true,
          list: [
            "**CRM as the core:** CRM serves as a mini-CDP, recording all customer interactions and touchpoints. It forms the foundation of our unification strategy by consolidating data from various sources.",
            "**Tracking digital footprints:** We use analytics tools like GA4 or GA360 to capture customers' digital activities, from viewing and clicking on campaigns to expressing interest in our products. This data is integrated into the CRM, enhancing its value.",
            "**Existing customer ecosystem:** Information about current policies and customers within our ecosystem is also integrated into the CRM. This allows for seamless marketing campaigns targeting both new and existing customers.",
          ],
        },
    ...
    },
    {
      ...
      answer: [
        "Today, the insurance industry's current initiatives with Google and Meta are primarily focused on customer acquisition. By integrating conversion APIs with their ecosystems, we share data with their advanced models to identify and target high-potential customers. This enables us to optimise our marketing campaigns, resulting in improved conversion rates and more efficient customer acquisition efforts.",
        "Regarding customer retention and experience, we have implemented AI and machine learning-based solutions to enhance customer interactions. While these are not generative AI initiatives, our use of chatbots has significantly improved the way we engage with customers at various stages of their journey.",
    ...
    {
      question:
        "Are there any specific areas in your day-to-day activities where you would like to highlight recent AI use cases you have developed?",
      answer: [
        "There are several initiatives we are currently working on, many of which align with industry trends. Here are two key use cases we have focused on in the contact centre space.",
        "**1. AI-powered contact centres for enhanced customer experience.** A significant challenge in contact centres is the variability in customer experience due to human factors. Despite uniform training, individual skills, fatigue, emotional state, and time of day can impact the quality of service. For instance:",
        {
          list: [
        ...
        "**2. AI-assisted callers for real-time feedback and quality assurance.** Another area of focus is improving agent efficiency and contact centre performance through AI-driven assistance. Traditionally, quality assurance involves reviewing a sample of calls and providing feedback to agents, which limits insights to a subset of interactions and relies on agents to remember and implement feedback during live calls.",
        "To overcome these limitations, we have implemented a solution that:",
        {
          list: [
            "**Audits 100% of calls:** Instead of sampling, all calls are reviewed, and detailed summaries are provided to agents.",
            "**Provides feedback summaries:** Daily summaries highlight areas of improvement, showing what has been addressed and what needs attention.",
            "**Offers live assistance:** We are trying to enable real-time assistance during calls. If an agent veers off track or fails to address a customer query effectively, the system can provide instant feedback, guiding the agent to correct the course during the interaction.",
          ],
        },
    ...
    {
      question:
        "There is ongoing discussion about AI replacing jobs. How has AI impacted staffing in your contact centre? Have roles been reduced, or have employees transitioned to other responsibilities as AI takes over certain tasks?",
      answer: [
        "Currently, AI has not fully replaced roles in contact centres, but its potential to handle transactional activities more efficiently is clear. While some jobs may eventually be replaced, the transition is likely to redefine roles rather than eliminate them entirely.",
    ...
    },
    {
      ...
      answer: [
        "Our KPIs remain consistent with what we have tracked traditionally. For the acquisition process, we focus on metrics like lead conversion ratios and final conversion ratios. From a marketing campaign perspective, we track KPIs such as cost per click, cost per lead, and cost per final conversion.",
        "What we primarily evaluate is the delta: the improvement brought by deploying these solutions. For instance, are we observing a positive shift in payment conversion ratios? Are we seeing a reduction in cost per acquisition?",
    ...
    {
      question:
        "Have the organisations you have worked with established an AI ethics committee or a team of leaders to ensure the responsible and ethical use of data and AI?",
      answer: [
        "In the life insurance industry, ensuring the ethical and responsible use of AI is not solely the responsibility of a dedicated committee. Instead, it is ingrained in the organisation's approach, mainly because data privacy and security are of paramount importance in this highly regulated and compliance-oriented sector. Every solution, whether AI-based or not, undergoes rigorous checks to ensure compliance with regulatory requirements and data security standards before deployment.",
    ...
    },
    {
      ...
      answer: [
        ...
        "It is important to manage expectations realistically and take a step-by-step approach. Begin with smaller, manageable implementations, evaluate their success, and expand gradually. This iterative process ensures the solution is robust, aligns with business goals, and delivers tangible value.",
    ...
    },
    {
      ...
      answer: [
        ...
        "Underwriting for such long-term contracts involves assessing customers both financially and medically. Currently, the industry relies on two primary mechanisms for medical underwriting:",
        {
          ordered: true,
          list: [
            "**Physical medical tests:** Customers visit diagnostic centres for prescribed tests, including blood and urine samples, followed by a medical examination conducted by qualified doctors. These results help determine the customer's eligibility for insurance products.",
            "**Video medical assessments:** For certain products, customers participate in video medical examinations. During these sessions, they answer health-related questions, and, if necessary, a follow-up physical test is conducted before issuing the policy.",
          ],
        },
