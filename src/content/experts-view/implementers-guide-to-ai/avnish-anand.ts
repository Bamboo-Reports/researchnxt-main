...
export const avnishAnand: ExpertInterview = {
  slug: "avnish-anand",
  ...
  metaDescription:
    "Avnish Anand, former Co-founder and CEO at CaratLane, on AI for imaging and personalisation, catching journey problems in real time, and why AI is a servant, not a magic wand.",

  title:
    "How Carat Lane is Redefining Customer Experience in the Jewellery Industry",
  person: {
    name: "Avnish Anand",
    role: "former Co-founder and CEO",
    company: "CaratLane",
  },

  thumbnail: "/experts/avnish-anand.png",
  thumbnailAlt: "Avnish Anand, former Co-founder and CEO at CaratLane",

  intro: [
    "Join Avnish Anand, former Co-founder and CEO at CaratLane, in an engaging conversation with Research NXT as he reveals the role of AI and technology in revolutionising the jewellery industry. Through this discussion, Avnish shares how CaratLane harnessed data-driven personalisation and cutting-edge innovations to elevate customer experiences and streamline operations. From overcoming challenges in AI adoption to exploring its strategic implications, this interview offers a fascinating look at the practical applications of AI in reshaping the future of jewellery retail.",
  ],

  highlights: [
    {
      title: "AI as a Strategic Tool for Personalisation",
      description:
        "AI has significantly enhanced imaging capabilities, personalised marketing, and customer interaction monitoring at CaratLane. It enables real-time identification of potential issues and creates tailored experiences for customers, reducing dependency on manual interventions.",
    },
    {
      title: "360-Degree Customer View and AI Utilisation",
      description:
        "While a comprehensive customer view can be achieved without AI, the technology's true value lies in processing and leveraging this data at scale to generate actionable insights and improve decision-making.",
    },
    {
      title: "AI's Role in Streamlining Processes",
      description:
        "From automating repetitive tasks like creative resizing to simplifying complex marketing strategies, AI has become an indispensable tool for driving efficiency and scalability.",
    },
    {
      title: "Challenges in AI Implementation",
      description:
        "The risk of over-reliance on AI and the potential for data misinterpretation emphasise the need for continuous human oversight. Regular validation and a balanced approach are critical to avoid significant missteps.",
    },
    {
      title: "Current AI Inflection Point",
      description:
        "The rapid advancements in AI capabilities over the past year have unlocked new possibilities, marking this phase as a transformative moment for businesses.",
    },
  ],
  ...
  exchanges: [
    {
      question:
        "Could you share a brief overview of your journey as a leader in the industry, focusing on how you have leveraged technology across various initiatives you have worked on? How have technology and AI evolved in your journey, and how are you integrating them into your current efforts?",
      answer: [
        "My journey with technology began in 2007 with CaratLane, where we built everything from scratch, as platforms like Shopify or Magento did not exist back then. Being in the jewellery industry, we faced unique challenges since most solutions were tailored for categories like fashion or electronics, not jewellery. This forced us to innovate and create tools specific to our needs.",
        "Although I was not formally trained in technology, my CaratLane experience introduced me to the power of data, marketing, and technology. Over the years, as ecosystems matured, tools for consumer analytics, marketing, and product management have significantly improved. However, in India, many businesses still struggle to maximise these tools' potential. While companies invest in analytics teams and tools, a deep understanding of their effective usage is often lacking.",
        "One key learning for me has been the importance of tracking critical metrics manually, even when they are not readily available in dashboards. Making that extra effort can offer a competitive advantage, especially in a landscape where most rely solely on automated insights.",
        "AI is revolutionising long-discussed concepts like personalisation. Until now, high-quality creatives and messaging have been expensive and resource-intensive to execute at scale. AI is beginning to solve these challenges by enabling more accessible and dynamic personalisation. Although its adoption is still in the early stages, I am optimistic that AI will transform how businesses deliver tailored experiences to consumers.",
        "At CaratLane, we experimented with such advancements, but there is still a long way to go. As AI tools evolve, I believe we will see widespread adoption of personalised messaging, notifications, and campaigns.",
    ...
    },
    {
      ...
      answer: [
        "AI, when used effectively, brings transformative changes across various functions. For instance, tasks like creating and repurposing creatives in multiple resolutions and formats, which previously required significant manual effort, can now be streamlined with AI. This eliminates repetitive, non-value-adding tasks, allowing teams to focus on more impactful work.",
    ...
    {
      question:
        "In our earlier conversation, you mentioned working on certain AI-driven personalisation use cases at CaratLane aimed at enhancing customer experience. Where do those personalisation efforts currently stand, and how do you see AI shaping the future of customer experience in this context?",
      answer: [
        "We have been working on several AI-driven initiatives, some of which have shown progress, while others remain a work in progress. In the jewellery industry, as with any visually driven category, the presentation of products is critical. AI can significantly enhance imaging capabilities by providing the right perspectives, showcasing designs, and suggesting styling options. While we have made advancements in this area, there is still a lot to refine and develop further.",
        "Another focus area is marketing and customer experience. AI helps us gather intelligence from data, create personalised communication, and improve overall customer interactions. For instance, we are using AI to proactively identify issues in the customer journey, whether on the website, during chats or calls, or in-store. Typically, customer experience is measured through NPS, which is collected at the end of a purchase. However, jewellery purchases often span several weeks, and issues during this journey might go unnoticed unless the customer complains.",
        "With AI, we are able to monitor and flag potential problems in real time, enabling immediate intervention by the team. This ensures issues are addressed promptly, enhancing the overall customer experience without waiting for feedback or complaints. It is like having an AI-powered system observing and ensuring everything is running smoothly, but on a scale that human monitoring could never achieve.",
        "In marketing, segmentation and personalisation have been key focus areas. We aim to create messaging, creatives, and product suggestions tailored to different customer segments. While progress has been made, there is still a massive opportunity to refine this further so that every customer, whether new or returning, feels their engagement with CaratLane is uniquely personalised.",
    ...
    {
      question:
        "From your perspective, what are the biggest challenges businesses face in leveraging data for AI-driven decision-making, and in responsibly utilising data through AI?",
      answer: [
        "AI is a powerful tool, but it is important to recognise its limitations. People should not expect AI to define and solve problems on its own. It is not a magic wand. The heavy lifting, defining problems, identifying use cases, and determining what you want AI to achieve, still requires significant human involvement. AI can assist as a servant, but it cannot replace the strategic and contextual understanding that humans bring to the table.",
        ...
        "Finally, a significant moral challenge with AI is its potential to make certain jobs redundant. For individuals who have not had the opportunity to learn more advanced skills, this can be a real threat. As leaders, it is crucial to prioritise upskilling and reskilling efforts, ensuring that the workforce evolves alongside technology. AI should be an enabler, not a replacement, and it is our responsibility to ensure that its adoption creates opportunities rather than displacing people.",
      ],
    },
    {
      question:
    ...
    {
      question:
        "Since a 360-degree view of the customer is often cited as a top priority in marketing tech, have you been able to achieve this at CaratLane? Or do you think it is a myth, even with advancements in AI and new-age technology?",
      answer: [
        "Achieving a 360-degree view of the customer does not necessarily require AI: it is more about collecting raw data, which existing technologies can manage effectively. Where AI becomes indispensable is in leveraging this comprehensive view.",
        "At CaratLane, for example, a typical customer takes three weeks to make a purchase, involving numerous interactions and transactions. Managing this for lakhs of customers is impossible manually, and that is where AI plays a critical role. AI processes and analyses this vast data, enabling intelligent interventions and generating actionable insights.",
